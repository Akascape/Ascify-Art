...
## DOWNLOAD
[`WINDOWS`](https://github.com/Akascape/Ascify-Art/releases/download/v0.2/Ascify-Art_win64.zip) [`python version`](https://github.com/Akascape/Ascify-Art/archive/refs/heads/Ascify-Art_v0.2.zip)
## How to Install?
For basic windows users, just extract the download zip file and run Ascify-Art.exe and use it.
<br>For python users, just extract the zip file and run Ascify-Art.py file. If any module error pops up then click on yer so that the modules get automatically downloaded(PIL and matplotlib). After installation of modules, the program is ready to use.
